...
export default function EsportsGames({ modes, onSelect, onShopClick }: EsportsGamesProps) {
  return (
    <section className="px-5 pt-8 pb-8">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <button
          onClick={onShopClick}
          className="group relative rounded-xl overflow-hidden aspect-[4/3] text-left bg-gradient-to-br from-amber to-[#2E1A6B] border border-white/10 shadow-lg shadow-black/20 transition-transform duration-150 active:scale-[0.97]"
        >
          <div className="absolute inset-0 bg-gradient-to-t from-black/55 via-black/5 to-transparent" />
          <div className="absolute -right-6 -top-6 w-24 h-24 rounded-full border border-white/15" />
